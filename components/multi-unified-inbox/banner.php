<div class="justify-self-start md:justify-self-start mt-2 md:mt-4">
      ...
      We provide a unified inbox for WhatsApp, SMS, email conversations   
      </p>
      <p class="text-center md:text-left text-white" id="ce">
       supporting multiple agents at the same time. This can be an
      </p>
	<p class="text-center md:text-left text-white" id="ce">
          extension of WhatsApp Chatbot <br> or independent.
      </p>
...
     const text = "Multi-Agent Unified Inbox";
     const speed = 100; 
