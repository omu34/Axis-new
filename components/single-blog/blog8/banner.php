<div class="justify-self-start md:justify-self-start mt-2 md:mt-4">
    <p class="text-center md:text-left text-white" id="ce">
        Conversational marketing is the way to go. People want you

    </p>
    <p class="text-center md:text-left text-white" id="ce">
        to engage them. To keep them informed
    </p>
    <p class="text-center md:text-left text-white" id="ce">
        in a direct, short and sweet way.
    </p>
...
<div class=" w-full md:w-1/2 p-4 text-center text-gray-700 lg:order-last md:justify-end absolute  md:-bottom-[380px]   -right-48 hidden md:hidden lg:block">
    <img class="animate__animated animate__slideInRight animate__repeat-0 animate__delay-1s min-h-[720px]  w-auto rounded-full" src="https://axis.africa/wp-content/uploads/2022/03/business-bulk-sms-min-scaled.jpg" alt="" srcset="">
</div>
</div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const text = 'Businesses That Would Benefit From AXIS Bulk SMS Platform';
        const speed = 100;
