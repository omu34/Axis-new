<div class="justify-self-start md:justify-self-start mt-2 md:mt-4">
    <p class="text-center md:text-left text-white" id="ce">
        Whatsapp has really revolutionized communication. As of
    <p class="text-center md:text-left text-white" id="ce">
        January 2022,data from Statista shows that it is one of
    </p>
    <p class="text-center md:text-left text-white" id="ce">
        the most used apps even ahead of Facebook Messenger.
    </p>
    </p>
</div>
...
<div class=" w-full md:w-1/2 p-4 text-center text-gray-700 lg:order-last md:justify-end absolute  md:-bottom-[380px]   -right-48 hidden md:hidden lg:block">
    <img class="animate__animated animate__slideInRight animate__repeat-0 animate__delay-1s min-h-[700px]  w-auto rounded-full" src="https://axis.africa/wp-content/uploads/2022/05/sms-marketing-min-scaled.jpg" alt="" srcset="">
