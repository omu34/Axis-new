<div class="justify-self-start md:justify-self-start mt-2 md:mt-4">
     <p class="text-center md:text-left text-white" id="ce">
      Businesses are using AXIS to sustain operations, connect with  customers  
      </p>
      <p class="text-center md:text-left text-white" id="ce">
       boost sales and increase  retention. We offer bulk SMS marketing as
      </p>
	<p class="text-center md:text-left text-white" id="ce">
         well   as two-way SMS.
      </p>
