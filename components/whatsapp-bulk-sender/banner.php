<div class="justify-self-start md:justify-self-start mt-2 md:mt-4">
     <p class="text-center md:text-left text-white" id="ce">
      This doesn’t require the official WhatsApp API, and it’s further 
      </p>
      <p class="text-center md:text-left text-white" id="ce">
       not supported by WhatsApp. Misuse of the tool  can lead to
      </p>
	<p class="text-center md:text-left text-white" id="ce">
        a number   being banned from WhatsApp.
      </p>
  ...
  <div class=" w-full md:w-1/2 p-4 text-center text-gray-700 lg:order-last md:justify-end absolute  md:-bottom-[380px]   -right-48 hidden md:hidden lg:block">
    <img class="animate__animated animate__slideInRight animate__repeat-0 animate__delay-1s min-h-[670px]  w-auto rounded-full" src="<?php echo home_url('/wp-content/uploads/2024/01/phone.webp'); ?>" alt="" srcset="">
  </div>
</div>
</div>
...
     const text = "Whatsapp Bulk Sender";
     const speed = 100; 
